...
## Доп. информация
* На данный момент сервер с нейронной сетью выключен(демонстрацию работы можно увидеть в папке [Demo](Demo))
* База данных со знаками сейчас частично синтетическая
